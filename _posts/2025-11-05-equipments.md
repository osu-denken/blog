...
ここから大学内のネットワーク（LEONET）を経由してインターネットを利用します。GE0のポートと大学のLANを接続します。
...
## パーツ類
ここで記載されているパーツは未使用品、組立て済みでない余ったものや展示用といったものとなります。
...
## スマートホーム類
### SwitchBot ロック Pro
締め忘れなどといった防犯対策のため、部室のドアの鍵の開閉をSwitchBotで管理しています。<br>
部屋の開閉状態を検知して数秒後、自動で施錠します。
