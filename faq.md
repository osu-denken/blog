...
A. 歓迎しています。共同イベント、勉強会、交流会、技術的なコラボレーションなどをご希望の場合は、お気軽にメール`denken.club@ge.osaka-sandai.ac.jp` (本部)、`master@osu-denken.net` (開発チーム)へお問い合わせください。内容を確認のうえ、ご連絡いたします。
